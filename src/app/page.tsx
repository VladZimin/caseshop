    ...
    <div className={'bg-slate-50'}>
      <section>
        <MaxWidthWrapper classname={'pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 ' +
          'lg:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'}>
            ...
            <div className={'relative mx-auto text-center lg:text-left ' +
              ...
              <div className={'mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5'}>
                ...
                <div className={'flex flex-col justify-between items-center sm:items-start'}>
                  ...
                  <p>
                    <span className={'font-semibold'}>3.200</span> happy customers
                  </p>
                </div>
              </div>
            </div>
        ...
        <MaxWidthWrapper classname={'flex flex-col items-center gap-16 sm:gap-32'}>
          <div className={'flex flex-col lg:flex-row items-center gap-4 sm:gap-6'}>
            <h2 className={'order-1 mt-2 tracking-tight text-center text-balance !leading-tight ' +
              ...
              <Icons.underline className={'hidden sm:block pointer-events-none absolute inset-x-0 ' +
                '-bottom-7 text-green-500'}/>
              </span>{' '}
              say
            </h2>
            <img src="/snake-2.png" alt="snake image" className={'w-24 order-0 lg:order-2'}/>
          </div>
          <div className={'mx-auto grid max-w-2xl grid-cols-1 px-4 lg:max-0 lg:max-w-none ' +
            ...
            <div className={'flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'}>
              ...
              <div className={'text-lg leading-8'}>
                <p>
                  ...
                  for two and a half months now and <span className={'p-0.5 bg-slate-800 text-white'}>the
                  image is super clear</span>, on the case I had before, the image started fading into
            ...
            <div className={'flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'}>
              ...
              <div className={'text-lg leading-8'}>
                <p>
                  ...
                  noticeable scratch on the corner, <span className={'p-0.5 bg-slate-800 text-white'}>
                  looks brand new after about half a year.</span> I did it{'"'}
                </p>
              </div>
              <div className={'flex gap-4 mt-2'}>
                <img
        ...
        <MaxWidthWrapper classname={'py-24'}>
          <div className={'mb-12 px-6 lg:px-8'}>
            <div className={'mx-auto max-w-2xl sm:text-center'}>
              <h2 className={'order-1 mt-2 tracking-light text-center text-balance !leading-tight ' +
                'font-bold text-5xl md:text-6xl text-gray-900'}>
          ...
          <div className={'mx-auto max-w-6xl px-6 lg:px-8'}>
            <div className={'relative flex flex-col items-center md:grid grid-cols-2 gap-40'}>
              <img
                src={'/arrow.png'}
                alt="Arrow"
                className={'absolute top-[25rem] md:top-1/2 -translate-y-1/2 z-10 left-1/2 ' +
                  '-translate-x-1/2 rotate-90 md:rotate-0'}
              />
